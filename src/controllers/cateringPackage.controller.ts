...
export class CateringPackageController extends BaseHttpController {
    ...
    @httpGet("/:id")
    public async getCateringPackageById(
        @request() req: Request,
        @response() res: Response,
        @next() next: NextFunction,
    ) {
        try {
            ...
            return res.status(HttpStatus.OK).json(ApiResponse.success("Catering package retrieved successfully", pkg));
        } catch (error) {
    ...
    public async updateCateringPackage(@request() req: Request, @response() res: Response, @next() next: NextFunction) {
        try {
            ...
            return res.status(HttpStatus.OK).json(ApiResponse.success("Catering package updated successfully", pkg));
        } catch (error) {
    ...
    public async deleteCateringPackage(@request() req: Request, @response() res: Response, @next() next: NextFunction) {
        try {
            ...
            return res.status(HttpStatus.OK).json(ApiResponse.success("Catering package deleted successfully"));
        } catch (error) {
